...
- Why host: Free to List, Keep 90%, Personal Support
- Average earnings data

**Form Card**
- Contact Information: Name*, Phone*, Email*
- Location: Location/Village*, State*
- Property Type: 8 toggle buttons (Farm, Terrace, Forest, Lakeside, Desert, Orchard, Roadside, Other)
- Amenities: 11 toggle buttons
- Description: Textarea
- Photos: Upload area (drag & drop visual)
