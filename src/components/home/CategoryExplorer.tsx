...
const categoryMarks = {
  "bring-your-own-tent": TentMark,
  "pre-pitched-glamping": TentMark,
  "farms-estates": LandFieldMark,
  "mountains-forests": CompassMark,
  waterside: MapPinMark,
  "road-trip-stops": RouteMark,
} satisfies Record<(typeof homeCategories)[number]["id"], typeof TentMark>;
              ...
              >
                <article>
                  <div className="relative aspect-[4/3] overflow-hidden rounded-[1.25rem] bg-[#dce9e1]">
                    ...
                    <span className="absolute right-4 top-4 grid h-11 w-11 place-items-center rounded-full border border-white/55 bg-[#fffaf0]/92 text-[#173525] shadow-sm backdrop-blur-sm">
                      <CategoryMark className="h-5 w-5" />
                    </span>
                  </div>
                  ...
                  <div className="flex min-h-36 items-start justify-between gap-5 border-b border-[#173525]/18 py-5">
                    ...
                    <span className="grid h-11 w-11 shrink-0 place-items-center rounded-full border border-[#173525]/30 text-[#173525] transition duration-200 group-hover:border-[#A94F08] group-hover:bg-[#A94F08] group-hover:text-white group-focus-visible:border-[#A94F08] group-focus-visible:bg-[#A94F08] group-focus-visible:text-white">
