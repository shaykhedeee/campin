...
- **Why We Exist:** Because India's outdoor soul is currently homeless. We are building the home for every Indian who craves a real campfire, a silent forest, and a safe sunrise, but finds only crowded hotels and unverified dirt patches.
- **Type:** Two-sided marketplace (Hosts ↔ Campers)
- **Earnings Model:** Host keeps 92% (8% platform fee)
- **Core Terminology:** "Host Your Land" (formerly List Your Space), "Support CampIn" (formerly Support)
